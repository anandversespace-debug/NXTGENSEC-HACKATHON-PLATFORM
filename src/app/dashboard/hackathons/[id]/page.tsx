...
export default function DashboardHackathonDetailsPage() {
  ...
  if (loading) return (
    <div className="flex items-center justify-center py-20">
      <div className="text-blue-500 font-black italic animate-pulse tracking-widest uppercase text-xs">Accessing Sprint Node...</div>
    </div>
  );
         ...
         <div className="flex flex-col md:flex-row md:items-start justify-between gap-8 relative z-10">
            <div>
               <div className="flex items-center space-x-3 mb-6">
                  ...
                  <span className="text-[9px] font-bold text-gray-700 uppercase tracking-widest italic tracking-tighter">PROTOCOL_NODE_0x{hackathon._id.slice(-4).toUpperCase()}</span>
               </div>
               ...
               <div className="flex items-center space-x-6 text-[10px] text-gray-600 font-bold uppercase tracking-widest mt-6">
                  ...
                  <span className="flex items-center italic"><MapPin className="w-3.5 h-3.5 mr-2 text-gray-700" /> VIRTUAL_HUB</span>
               </div>
            </div>
            ...
            <div className="flex flex-col items-end">
               <div className="text-right bg-[#050505] border border-white/5 rounded-2xl p-8 group-hover:border-emerald-500/20 transition-all duration-700 shadow-inner">
                  <p className="text-[9px] font-black text-gray-700 uppercase tracking-widest mb-3 italic">Bounty Matrix Pool</p>
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 space-y-8">
              <div className="bg-[#0c0c0c] border border-white/5 rounded-3xl p-10 relative overflow-hidden group">
                 ...
                 <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-8 italic border-l-2 border-blue-500 pl-4">Briefing Archive</h2>
           ...
           <div className="space-y-8">
              <div className="bg-[#0c0c0c] border border-white/5 rounded-3xl p-8 group hover:border-white/10 transition-colors">
                 <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-gray-700 mb-8 italic">Telemetry Nodes</h2>
                 <div className="space-y-6">
                    <div className="flex justify-between items-center border-b border-white/[0.03] pb-5 group/item">
                       <span className="text-[10px] text-gray-600 font-bold uppercase tracking-widest flex items-center italic group-hover/item:text-blue-500 transition-colors"><Users className="w-3.5 h-3.5 mr-3" /> REGISTERED_PEERS</span>
                       <span className="text-xs font-black text-gray-200 tracking-widest italic">500+ Nodes</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 group/item">
                       <span className="text-[10px] text-gray-600 font-bold uppercase tracking-widest flex items-center italic group-hover/item:text-emerald-500 transition-colors"><Activity className="w-3.5 h-3.5 mr-3" /> CURRENT_PHASE</span>
                       <span className="text-[9px] font-black uppercase tracking-[0.2em] text-blue-500 bg-blue-500/5 px-3 py-1 rounded border border-blue-500/20 italic shadow-xl">PROTOCOL_SYNC</span>
                    </div>
                 </div>
              </div>
           </div>
      ...
      {activeTab === 'submission' && (
        <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }}>
           <div className="bg-[#0c0c0c] border border-white/5 rounded-3xl p-16 text-center max-w-2xl mx-auto mt-10 relative group overflow-hidden">
              ...
              <h3 className="text-xl font-black text-white uppercase tracking-tighter italic mb-4">No Active Binding Detected</h3>
              <p className="text-[11px] text-gray-600 font-bold uppercase tracking-widest leading-loose mb-10 max-w-sm mx-auto italic">
                 You have not injected a project repository into this mission's block registry. Construct your primary submission to enter the sprint hierarchy.
              </p>
